...
class BananaManiaWorld(World):
    """
    Super Monkey Ball Banana Mania is a Super Monkey Ball game that brings together the
    classic levels from Super Monkey Ball 1 and 2, with remastered graphics and new modes.
    """
    ...
    web = web_world.BananaManiaWebWorld()

    # This is how we associate the options defined in our options.py with our world.
    # (Note: options.py has been imported as "apquest_options" at the top of this file to avoid a name conflict)
    options_dataclass = apquest_options.BananaManiaOptions
    options: apquest_options.BananaManiaOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
    ...
    def create_item(self, name: str) -> items.BananaManiaItem:
    ...
    def fill_slot_data(self) -> Mapping[str, Any]:
        ...
        return self.options.as_dict(
            "banana_missions", "time_missions", "extra_goals", "world_structure"
        )
