...
def create_regular_locations(world: BananaManiaWorld) -> None:
    ...
    bottom_left_chest = BananaManiaLocation(
    ...
    bottom_right_room.add_locations(bottom_right_room_locations, BananaManiaLocation)

    top_left_room_locations = get_location_names_with_ids(["Top Left Room Chest"])
    top_left_room.add_locations(top_left_room_locations, BananaManiaLocation)

    right_room_locations = get_location_names_with_ids(["Right Room Enemy Drop"])
    right_room.add_locations(right_room_locations, BananaManiaLocation)
    ...
    if world.options.hammer:
        ...
        top_middle_room.add_locations(top_middle_room_locations, BananaManiaLocation)
    else:
        overworld.add_locations(top_middle_room_locations, BananaManiaLocation)
    ...
    if world.options.extra_starting_chest:
        ...
        overworld.add_locations(bottom_left_extra_chest, BananaManiaLocation)
...
def create_events(world: BananaManiaWorld) -> None:
    ...
    button_in_top_left_room = BananaManiaLocation(world.player, "Top Left Room Button", None, top_left_room)
    ...
    button_item = items.BananaManiaItem("Top Left Room Button Pressed", ItemClassification.progression, None, world.player)
    ...
    final_boss_room.add_event(
        "Final Boss Defeated", "Victory", location_type=BananaManiaLocation, item_type=items.BananaManiaItem
    )
